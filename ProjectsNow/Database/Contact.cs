...
{
    [ReadTable("[Customer].[Contacts]")]
    [WriteTable("[Customer].[Contacts]")]
	public class Contact : INotifyPropertyChanged
	{
		...
		[ID] public int ContactID { get; set; }
		...
		public string ContactName
		{
			...
			set { if (value != this._ContactName) { this._ContactName = value; NotifyPropertyChanged(); } }
		}
