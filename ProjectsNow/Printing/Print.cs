...
namespace ProjectsNow.Printing
{
    class Print
    {
        ...
        public static void PrintPreview(FrameworkElement Page, string documentName, PageOrientation pageOrientation)
        {
            if (System.IO.File.Exists("PrintPreview.xps"))
            { System.IO.File.Delete("PrintPreview.xps"); }
        ...
        public static void PrintPreview(List<FrameworkElement> Pages, string documentName, PageOrientation pageOrientation)
        {
            if (System.IO.File.Exists("PrintPreview.xps"))
            { System.IO.File.Delete("PrintPreview.xps"); }
