...
{
    public partial class DownloadPanelWindow : Window
    {
        ...
        private void Save_Click(object sender, RoutedEventArgs e)
        {
            ...
            newPanelData.QuotationID = QuotationToUpdate.QuotationID;
            ...
            using (SqlConnection connection = new SqlConnection(DatabaseAI.ConnectionString))
            {
                ...
                if (items.Count != 0)
                {
                    var insert = $"Insert Into [Quotation].[QuotationsPanelsItems] " +
                                 ...
                                 $"Values " +
                                 $"({newPanelData.PanelID}, @Article1, @Article2, @Category, @Code, @Description, @Unit, @ItemQty, @Brand, @Remarks, @ReferenceCost, @ReferenceDiscount, @ItemTable, @ItemType, @ItemSort)";
